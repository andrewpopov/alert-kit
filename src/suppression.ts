...
export function initialSuppressionState(): SuppressionState {
...
export function stepCheck(
  prev: SuppressionState | undefined,
 ...
 */
export function unsentAlertState(prev: SuppressionState | undefined, next: SuppressionState): SuppressionState {
  const p = prev || initialSuppressionState();
  const rolledBack: SuppressionState = {
    ...next,
    notif: p.notif,
